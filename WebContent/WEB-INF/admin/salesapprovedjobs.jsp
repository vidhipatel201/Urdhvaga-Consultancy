...
<jsp:include page="header.jsp" flush="true">
    <jsp:param name="title" value="Sales Approved Job Applications - Urdhvaga Consultancy"/>
</jsp:include>
<!-- Modal -->
...
<script src="<%=RouteManager.getBasePath()%>assets/js/pagination.js"></script>
	...
	$(document).ready(function() {
		...
		$("#candidateDetails_container").hide();
		 $("#jobRequirements").jPagination({
		    	...
		    	filter: filtering,
		    	source: "<%=RouteManager.getBasePath()%>admin/manage-job-applications?action=getSalesApprovedJobs"
		    });
	});
	...
	function showDetails(btn, id) {
		...
		$.ajax({
			url: "<%=RouteManager.getBasePath()%>admin/manage-job-applications?action=showFinalDetails",
			method: 'POST',
			data: {
				'jobId':id,
			},
			success: function(data) {
				...
				$("#applicationDetails").jPagination({
			    	...
			    	extraParameters: criterias,
			    	filter: filtering,
			    	source: "<%=RouteManager.getBasePath()%>admin/manage-job-applications?action=getFinalApplicationList"
			    });
	...
	function acceptApplication(btn, jobId) {
		btn.innerHTML = "Please wait";
		$.ajax({
			url: '<%=RouteManager.getBasePath()%>admin/manage-job-applications?action=acceptApplicationFinal',
			method: 'POST',
			data: {
				"jobId": jobId,
			},
	...
	function rejectApplication(btn) {
		...
		$.ajax({
			url: '<%=RouteManager.getBasePath()%>admin/manage-job-applications?action=rejectApplicationFinal',
			method: 'POST',
			data: {
	...
	function acceptJob(btn, jobId) {
		btn.innerHTML = "Please wait";
		$.ajax({
			url: '<%=RouteManager.getBasePath()%>admin/manage-job-applications?action=acceptJobTelecallerFinal',
			method: 'POST',
			data: {
				'jobId': jobId,
			},
	...
	function rejectJob(btn) {
		btn.innerHTML = "Please wait";
		$.ajax({
			url: '<%=RouteManager.getBasePath()%>admin/manage-job-applications?action=rejectJobTelecallerFinal',
			method: 'POST',
			data: {
